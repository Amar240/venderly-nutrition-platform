...
export default function ReportsHubPage() {
  const reports = [
    ...
    { href: "/admin/reports/claim-pack", title: "Claim pack", desc: "A printable document for a state reviewer: totals, daily counts, the claiming math, exceptions, and corrections." },
